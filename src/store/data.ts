export const data = {
  ...
  skills: {
    ...
    list: [
      ...
      {
        name: "Soft skills",
        list: ["Team-player, fast learner", "Languages: English, Indonesia"],
      },
    ],
  },
  experience: {
    ...
    list: [
      ...
      },
      {
        ...
        details: ["Developed HR platform web apps using Angular"],
      },
      {
        company: "GDP Labs",
        ...
        details: [
          "Developed vehicle insurance enterprise application using Angular",
        ],
      },
    ],
  },
